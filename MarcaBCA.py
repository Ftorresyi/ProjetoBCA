...
OMs=[
    'GAP GL','GAP-GL','GRUPAMENTO DE APOIO DO GALEÃO',
    'PAMA GL','PAMA-GL','PARQUE DE MATERIAL AERONÁUTICO DO GALEÃO',  
    'BAGL','BASE AÉREA DO GALEÃO','BAGL_ANTIGA'
    'CMRJ','COLÉGIO MILITAR DO RIO DE JANEIRO',
    '1 CJM','1° CJM','PRIMEIRA CIRCUNSCRIÇÃO JUDICIÁRIA MILITAR',
    ' CEMAL','CENTRO DE MEDICINA AEROESPACIAL',    
    'BINFAE GL','BINFAE-GL','BATALHÃO DE INFANTARIA DA AERONÁUTICA ESPECIAL DO GALEÃO',
    'CCA RJ','CENTRO DE COMPUTAÇÃO DA AERONÁUTICA DO RIO DE JANEIRO',      
    'PAGL','PREFEITURA DE AERONÁUTICA DO GALEÃO',
    ' 3 ETA ',' 3° ETA ','TERCEIRO ETA',
    ' GOP GL ',' GOP-GL ', 'GRUPO OPERACIONAL DO GALEÃO',
    ' GLOG GL ','GLOG-GL','GRUPO LOGÍSTICO DO GALEÃO', 
    ...
    'PAMB RJ','PAMB-RJ''PARQUE DE MATERIAL BÉLICO DA AERONÁUTICA DO RIO DE JANEIRO',
    'DTCEA-GL','DTCEA GL','DESTACAMENTO DE CONTROLE DO ESPAÇO AÉREO DO GALEÃO',
    ' 1/2 GT',' 1°/2° GT','PRIMEIRO ESQUADRÃO DO SEGUNDO GRUPO DE TRANSPORTE',
    ' 1 GCC','PRIMEIRO GRUPO DE COMUNICAÇÕES E CONTROLE',' 1° GCC',
    ' 1/1 GT',' 1°/1° GT','PRIMEIRO ESQUADRÃO DO PRIMEIRO GRUPO DE TRANSPORTE',
    ' 2/2 GT',' 2°/2° GT','SEGUNDO ESQUADRÃO DO SEGUNDO GRUPO DE TRANSPORTE',
    'LAQFA','LABORATÓRIO QUÍMICO-FARMACÊUTICO DA AERONÁUTICA',
    'CTLA','CENTRO DE TRANSPORTE LOGÍSTICO DA AERONÁUTICA',
    'ALA 11', 'BASE AÉREA DO GALEÃO'
    ...
    'GSD-GL','GRUPO DE SEGURANÇA E DEFESA DO GALEÃO',
    'HFAG', 'HOSPITAL DE FORÇA AÉREA DO GALEÃO', 
    'MOVIMENTAÇÃO', 'PROMOÇÃO', 'COGITAÇÃO']
