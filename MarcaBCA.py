...
OMs=[
    ...
    '1 CJM','1° CJM','PRIMEIRA CIRCUNSCRIÇÃO JUDICIÁRIA MILITAR',' CEMAL','CENTRO DE MEDICINA AEROESPACIAL',
    ' 2/2 GT','2°/2° GT','SEGUNDO ESQUADRÃO DO SEGUNDO GRUPO DE TRANSPORTE','CCA RJ','CENTRO DE COMPUTAÇÃO DA AERONÁUTICA DO RIO DE JANEIRO',
    'PAGL','PREFEITURA DE AERONÁUTICA DO GALEÃO',' 1 GCC',' 1° GCC','PRIMEIRO GRUPO DE COMUNICAÇÕES E CONTROLE',
    ...
    'DTCEA-GL','DESTACAMENTO DE CONTROLE DO ESPAÇO AÉREO DO GALEÃO',' 1/2 GT','1°/2° GT','PRIMEIRO ESQUADRÃO DO SEGUNDO GRUPO DE TRANSPORTE',
    'BINFAE GL','BATALHÃO DE INFANTARIA DA AERONÁUTICA ESPECIAL DO GALEÃO',
    ' 1/1 GT','1°/1° GT','PRIMEIRO ESQUADRÃO DO PRIMEIRO GRUPO DE TRANSPORTE','LAQFA','LABORATÓRIO QUÍMICO-FARMACÊUTICO DA AERONÁUTICA',
    ...
    'GSD-GL','GRUPO DE SEGURANÇA E DEFESA DO GALEÃO','HFAG', 'HOSPITAL DE FORÇA AÉREA DO GALEÃO', '3 ETA','3° ETA','TERCEIRO ETA', 
    'MOVIMENTAÇÃO', 'PROMOÇÃO', 'COGITAÇÃO', 'CURSO']
