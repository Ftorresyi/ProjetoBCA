...
PalavrasChave=['PORTARIA DIRAP','(','/','à','Subdiretor Interino de Pessoal Militar da Dirap']
        ...
        for inst in text_instances:
          ...
          for annot in page.annots():
            if (inst.intersect(annot.rect)):
              print("Remove anotacao ", palavra ," pag", page.number)
              page.delete_annot(annot)
    
  BcadoDia.save(input("Digite o nome do arquivo que será salvo: "))


pdfmarcado=MarcaOMsApoiadas(input("Digite o nome do BCA que será lido: "))
removeHighlightv2(pdfmarcado, PalavrasChave)
